...
namespace Company.IntegrationService.BusinessLayer.Components.LoansService
{
    ...
    public class GetProductsProcessRequestComponent : IProcessRequestComponent<GetProductsRequest, GetProductsResponse>
    {
        // Manages all of its own dependencies
        private readonly ProductsClientProxy products = null;

        public GetProductsProcessRequestComponent(ProductsClientProxy products)
        {
            if (products == null)
